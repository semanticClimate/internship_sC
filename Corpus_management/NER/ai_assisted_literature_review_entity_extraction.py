# -*- coding: utf-8 -*-
"""Copy of AI-Assisted_Literature-Review_ENTITY_EXTRACTION.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1oPgnTC4UrBJF-8W2t508voWEsu8_z4ac
...
# Load the CSV
file_path = 'gene_frequency.csv'  # Update with your actual CSV path
df = pd.read_csv(file_path)

# Extract only the gene and PMCID columns (skip total frequency)
gene_names = df['Gene/Gene Product']
frequency_matrix = df.iloc[:, 2:]
