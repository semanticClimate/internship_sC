...
# Step 1: Input / Output
# ==========================
input_file = r"c:\Users\workt\Desktop\IPCC\keywords\keylist"
output_file = r"C:\Users\workt\Desktop\internship_sC\MP-project\papers\cleaned_encyclopedia.html"
graph_html = r"C:\Users\workt\Desktop\internship_sC\MP-project\papers\encyclopedia_kg_visual.html"
...
print(f":white_check_mark: Cleaned file saved: {output_file}")
...
# ==========================
print(":brain: Building Knowledge Graph...")
...
print(f":jigsaw: Nodes: {len(G.nodes)}")
print(f":link: Edges: {len(G.edges)}")

# Save GraphML
nx.write_graphml(G, graphml_path)
print(f":white_check_mark: GraphML saved: {graphml_path}")
...
for node, data in G.nodes(data=True):
    ...
    if degree >= 8:
        color = "#00FF99"      # :large_green_circle: Highly Connected Nodes
        label_type = "Highly Connected Node"

    elif degree >= 4:
        color = "#66B2FF"      # :large_blue_circle: Main Topics
        label_type = "Main Topic"

    elif degree >= 2:
        color = "#FF9933"      # :large_orange_circle: Subfields / Categories
        label_type = "Subfield / Category"

    else:
        color = "#FF5555"      # :red_circle: Related Concept
